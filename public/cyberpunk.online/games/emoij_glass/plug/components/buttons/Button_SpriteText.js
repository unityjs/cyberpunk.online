var bcounts=0
function Button_SpriteText(atlasId,onMouseDown,vars){var self=Sprites.cast(this,atlasId)
self.id=bcounts++
self.sprite=self
...
var offSprite
var isMouseOver
var textField=self.textField=Texts.spawnBitmap("stroke",{parent:self,size:120,text:"title",tint:0x000000})
self.sound="button"
...
if(vars.tint)self.tint=vars.tint
scale=vars.scale||1
...
Pool.registerSprite("Button_SpriteText",Button_SpriteText)