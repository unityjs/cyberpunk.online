    ...
    readAttachment: function(a, b, c, d) {
        ...
        switch (e) {
            ...
            case spine.AttachmentType.boundingbox:
                for (var u = this.attachmentLoader.newBoundingBoxAttachment(a, c), l = d.vertices, o = 0, r = l.length; o < r; o++) u.vertices[o] = l[o] * g;
                return u
        }
...
! function(a) {
    var b = function(b) {
        function c(c, d, e) {
            ...
            f.onEvent = new Phaser.Signal, f.skeleton = new spine.Skeleton(f.skeletonData), f.skeleton.updateWorldTransform(), f.stateData = new spine.AnimationStateData(f.skeletonData), f.state = new spine.AnimationState(f.stateData), f.state.onEvent = f.onEvent.dispatch.bind(f.onEvent), f.slotContainers = [];
